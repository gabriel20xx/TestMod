package com.clasher.terrariamod.world.biomes;
...
public class CorruptionBiome extends Biome {
    public CorruptionBiome(Builder biomeBuilder) {
        ...
        this.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(WorldCarver.CAVE, new ProbabilityConfig(0.14F)));
